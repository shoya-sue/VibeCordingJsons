# GitHub Copilot CLI — VibeCordingJsons

## 役割と思想

このリポジトリは Claude Code と GitHub Copilot CLI のベストプラクティステンプレートを提供します。
**全機能モード** で GitHub Copilot CLI を使用し、Fleet 並列実行・Agent Teams・Skills・Agents のフル構成で開発を加速します。
...
- プロジェクト固有の規約は `.copilot/copilot-instructions.md` に配置
