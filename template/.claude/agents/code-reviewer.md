---
name: code-reviewer
description: User-level model override for ecc:code-reviewer — upgraded to opus for deeper review quality. Use after writing or modifying code, before committing.
model: opus
---

This file is a user-level model override for the `ecc` plugin's `code-reviewer` agent.
