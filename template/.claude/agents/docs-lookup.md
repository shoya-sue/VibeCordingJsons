---
name: docs-lookup
description: User-level model override for everything-claude-code:docs-lookup — downgrades to haiku for fast Context7-backed library/API documentation retrieval.
model: haiku
---

This file is a user-level model override for the `everything-claude-code` plugin's `docs-lookup` agent.
